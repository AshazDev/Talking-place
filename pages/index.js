      ...
      >
        ...
        <div className='flex items-center'>
          {user ? (
            <button
              onClick={signOut}
              className='uppercase text-sm font-medium text-white hover:text-white tracking-wide hover:bg-KaiBrand-500 bg-transparent rounded py-2 px-4 mr-4 focus:outline-none focus:ring focus:ring-KaiBrand-500 focus:ring-opacity-75 transition-all'
            >
              Sign out
            </button>
          ) : null}
